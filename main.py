...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.heading('costs', text='Дохід/витрата')
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        self.title('Дохід/витрата')
        self.geometry('400x220+400+300')
        self.resizable(False, False)

        label_description = tk.Label(self, text='Найменування:')
        label_description.place(x=50, y=50)
        label_select = tk.Label(self, text='Дохід/витрата:')
...
if __name__ == "__main__":
    ...
    app = Main(root)
    app.pack()
    root.title("Фінансови підрахунки,для того щоб вистачило на Байкрактар !")
    root.geometry("680x550+400+300")
